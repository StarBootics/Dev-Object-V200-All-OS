...
; Nom du fichier : DevObject - BinaryFile.pb
...
Module BinaryFile
  ...
  Procedure.s GenerateReadDeclare(*This.Private_Members, *Class.Class::Class,  *Comments.Comments::Comments, Mode.i)
    ...
    Select Mode
      ...
      Case 0
        Buffer.s = *Comments\Tabulation(2) + "Read" + *Class\GetName() + "(FileID.i)" + *Comments\LineFeed()
        
      Case 1
        Buffer = *Comments\Tabulation(2) + "Data.i @Read" + *Class\GetName() + "()" + *Comments\LineFeed()
  ...
  Procedure.s GenerateWriteDeclare(*This.Private_Members, *Class.Class::Class, *Comments.Comments::Comments, Mode.i)
    ...
    Select Mode
      ...
      Case 0
        Buffer.s = *Comments\Tabulation(2) + "Write" + *Class\GetName() + "(FileID.i)" + *Comments\LineFeed()
        
      Case 1
        Buffer = *Comments\Tabulation(2) + "Data.i @Write" + *Class\GetName() + "()" + *Comments\LineFeed()
  ...
  Procedure.s GenerateReadDefine(*This.Private_Members, *Class.Class::Class, *Comments.Comments::Comments, *Rules.Rules::Rules)
    ...
    Buffer.s = *Comments\Tabulation(1) + "Procedure Read" + *Class\GetName() + "(*This.Private_Members, FileID.i)" + *Comments\LineFeed()
      ...
      Select *Members\GetLinkTag()
        ...
        Case Class::#MEMBER_STYLE_ARRAY
          *DynamicArray.DynamicArray::DynamicArray = *Members\GetLinkObject()
          Instruction.s = *DynamicArray\GenerateReadBinaryInstruction(*Comments, 2, *Rules) 
          SeparatorNeeded.i = #True
          
        Case Class::#MEMBER_STYLE_LIST
          *LinkedList.LinkedList::LinkedList = *Members\GetLinkObject()
          Instruction = *LinkedList\GenerateReadBinaryInstruction(*Comments, 2, *Rules) 
          SeparatorNeeded = #True
          
        Case Class::#MEMBER_STYLE_MAP
          *HashMap.HashMap::HashMap = *Members\GetLinkObject()
          Instruction = *HashMap\GenerateReadBinaryInstruction(*Comments, 2, *Rules) 
          SeparatorNeeded = #True
          
        Case Class::#MEMBER_STYLE_BASIC
          *Basic.Basic::Basic = *Members\GetLinkObject()
          Instruction = *Basic\GenerateReadBinaryInstruction(*Comments, 2)
        ...
        Case Class::#MEMBER_STYLE_STATIC_ARRAY
          *StaticArray.StaticArray::StaticArray = *Members\GetLinkObject()
          Instruction = *StaticArray\GenerateReadBinaryInstruction(*Comments, 2) 
          SeparatorNeeded = #True
  ...
  Procedure.s GenerateWriteDefine(*This.Private_Members, *Class.Class::Class, *Comments.Comments::Comments, *Rules.Rules::Rules)
    ...
    Buffer.s = *Comments\Tabulation(1) + "Procedure Write" + *Class\GetName() + "(*This.Private_Members, FileID.i)" + *Comments\LineFeed()
    ...
    *Members\ResetChain()
    ...
    While *Members\NextLink()
      ...
      Select *Members\GetLinkTag()
        ...
        Case Class::#MEMBER_STYLE_ARRAY
          *DynamicArray.DynamicArray::DynamicArray = *Members\GetLinkObject()
          Instruction.s = *DynamicArray\GenerateWriteBinaryInstruction(*Comments, 2, *Rules) 
          SeparatorNeeded.i = #True
          
        Case Class::#MEMBER_STYLE_LIST
          *LinkedList.LinkedList::LinkedList = *Members\GetLinkObject()
          Instruction = *LinkedList\GenerateWriteBinaryInstruction(*Comments, 2, *Rules) 
          SeparatorNeeded = #True
          
        Case Class::#MEMBER_STYLE_MAP
          *HashMap.HashMap::HashMap = *Members\GetLinkObject()
          Instruction = *HashMap\GenerateWriteBinaryInstruction(*Comments, 2, *Rules) 
          SeparatorNeeded = #True
          
        Case Class::#MEMBER_STYLE_BASIC
          *Basic.Basic::Basic = *Members\GetLinkObject()
          Instruction = *Basic\GenerateWriteBinaryInstruction(*Comments, 2) 
          SeparatorNeeded = #False
          
        Case Class::#MEMBER_STYLE_STATIC_ARRAY
          *StaticArray.StaticArray::StaticArray = *Members\GetLinkObject()
          Instruction = *StaticArray\GenerateWriteBinaryInstruction(*Comments, 2) 
          SeparatorNeeded = #True
    ...
    *Members\ResetChain()
    ...
    While *Members\NextLink()
      ...
      Select *Members\GetLinkTag()
        ...
        Case Class::#MEMBER_STYLE_ARRAY
          *DynamicArray.DynamicArray::DynamicArray = *Members\GetLinkObject()
          Instruction.s = *DynamicArray\GenerateWriteBinaryInstruction(*Comments, 3, *Rules) 
          SeparatorNeeded.i = #True
          
        Case Class::#MEMBER_STYLE_LIST
          *LinkedList.LinkedList::LinkedList = *Members\GetLinkObject()
          Instruction = *LinkedList\GenerateWriteBinaryInstruction(*Comments, 3, *Rules) 
          SeparatorNeeded = #True
          
        Case Class::#MEMBER_STYLE_MAP
          *HashMap.HashMap::HashMap = *Members\GetLinkObject()
          Instruction = *HashMap\GenerateWriteBinaryInstruction(*Comments, 3, *Rules) 
          SeparatorNeeded = #True
          
        Case Class::#MEMBER_STYLE_BASIC
          *Basic.Basic::Basic = *Members\GetLinkObject()
          Instruction = *Basic\GenerateWriteBinaryInstruction(*Comments, 3) 
          SeparatorNeeded = #False
          
        Case Class::#MEMBER_STYLE_STATIC_ARRAY
          *StaticArray.StaticArray::StaticArray = *Members\GetLinkObject()
          Instruction = *StaticArray\GenerateWriteBinaryInstruction(*Comments, 3) 
          SeparatorNeeded = #True
  ...
  Procedure.s GenerateOpenFileDefine(*This.Private_Members, *Class.Class::Class, *Comments.Comments::Comments, *Rules.Rules::Rules)
    ...
    Buffer.s = *Comments\Tabulation(1) + "Procedure.i Open" + *Class\GetName() + "File(*This.Private_Members, FileName.s)" + *Comments\LineFeed()
    Buffer + *Comments\Tabulation(2) + *Comments\LineFeed()
    ...
    *Members\ResetChain()
    ...
    While *Members\NextLink()
      ...
      Select *Members\GetLinkTag()
        ...
        Case Class::#MEMBER_STYLE_ARRAY
          *DynamicArray.DynamicArray::DynamicArray = *Members\GetLinkObject()
          Instruction.s = *DynamicArray\GenerateReadBinaryInstruction(*Comments, TabSize, *Rules) 
          SeparatorNeeded.i = #True
          
        Case Class::#MEMBER_STYLE_LIST
          *LinkedList.LinkedList::LinkedList = *Members\GetLinkObject()
          Instruction = *LinkedList\GenerateReadBinaryInstruction(*Comments, TabSize, *Rules) 
          SeparatorNeeded = #True
          
        Case Class::#MEMBER_STYLE_MAP
          *HashMap.HashMap::HashMap = *Members\GetLinkObject()
          Instruction = *HashMap\GenerateReadBinaryInstruction(*Comments, TabSize, *Rules) 
          SeparatorNeeded = #True
          
        Case Class::#MEMBER_STYLE_BASIC
          *Basic.Basic::Basic = *Members\GetLinkObject()
          Instruction = *Basic\GenerateReadBinaryInstruction(*Comments, TabSize)
        ...
        Case Class::#MEMBER_STYLE_STATIC_ARRAY
          *StaticArray.StaticArray::StaticArray = *Members\GetLinkObject()
          Instruction = *StaticArray\GenerateReadBinaryInstruction(*Comments, TabSize)
          SeparatorNeeded = #True
  ...
  Procedure.s GenerateReadFileDefine(*This.Private_Members, *Class.Class::Class, *Comments.Comments::Comments, *Rules.Rules::Rules)
    ...
    Buffer.s = *Comments\Tabulation(1) + "Procedure.i Read" + *Class\GetName() + "File(*This.Private_Members, FileName.s)" + *Comments\LineFeed()
    Buffer + *Comments\Tabulation(2) + *Comments\LineFeed()
